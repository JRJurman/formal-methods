...
#define nstates7	12	/* Liveness2 */
#define endstate7	11
short src_ln7 [] = {
	  0,  42,  42,  43,  43,  41,  45,  47, 
	 47,  46,  49,  49,   0, };
S_F_MAP src_file7 [] = {
	{ ""-"", 0, 0 },
	{ "_spin_nvr.tmp", 1, 11 },
...
#define nstates6	12	/* Liveness */
#define endstate6	11
short src_ln6 [] = {
	  0,  31,  31,  32,  32,  30,  34,  36, 
	 36,  35,  38,  38,   0, };
S_F_MAP src_file6 [] = {
	{ ""-"", 0, 0 },
	{ "_spin_nvr.tmp", 1, 11 },
...
#define nstates5	7	/* Safety2 */
#define endstate5	6
short src_ln5 [] = {
	  0,  23,  23,  22,  25,  26,  27,   0, };
S_F_MAP src_file5 [] = {
	{ ""-"", 0, 0 },
	{ "_spin_nvr.tmp", 1, 6 },
	{ ""-"", 7, 8 }
...
#define nstates3	8	/* :init: */
#define endstate3	7
short src_ln3 [] = {
	  0, 106, 107, 108, 109, 110, 105, 112, 
	  0, };
S_F_MAP src_file3 [] = {
	{ ""-"", 0, 0 },
	{ "shift-alt-esc2.pml", 1, 7 },
	{ ""-"", 8, 9 }
};
uchar reached3 [] = {
	  0,   1,   0,   0,   0,   0,   0,   0, 
...
#define nstates2	18	/* Server */
#define endstate2	17
short src_ln2 [] = {
	  0,  89,  90,  90,  90,  90,  92,  93, 
	 95,  96,  97,  99, 100, 100,  86, 102, 
	 86, 102,   0, };
S_F_MAP src_file2 [] = {
	{ ""-"", 0, 0 },
	{ "shift-alt-esc2.pml", 1, 17 },
	{ ""-"", 18, 19 }
};
uchar reached2 [] = {
	  0,   1,   1,   0,   1,   0,   0,   0, 
...
#define nstates1	25	/* Cashier */
#define endstate1	24
short src_ln1 [] = {
	  0,  66,  66,  67,  68,  68,  68,  68, 
	 69,  70,  70,  72,  74,  74,  74,  74, 
	 75,  77,  78,  78,  79,  63,  81,  63, 
	 81,   0, };
S_F_MAP src_file1 [] = {
	{ ""-"", 0, 0 },
	{ "shift-alt-esc2.pml", 1, 24 },
	{ ""-"", 25, 26 }
};
uchar reached1 [] = {
	  0,   1,   1,   0,   1,   0,   1,   0, 
...
#define nstates0	27	/* Customer */
#define endstate0	26
short src_ln0 [] = {
	  0,  41,  43,  44,  44,  45,  45,  45, 
	 45,  47,  47,  47,  47,  49,  50,  51, 
	 51,  52,  54,  54,  54,  54,  56,  38, 
	 58,  38,  58,   0, };
S_F_MAP src_file0 [] = {
	{ ""-"", 0, 0 },
	{ "shift-alt-esc2.pml", 1, 26 },
	{ ""-"", 27, 28 }
};
uchar reached0 [] = {
	  0,   1,   0,   1,   0,   1,   0,   1, 
...
typedef struct P7 { /* Liveness2 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
} P7;
#define Air7	(sizeof(P7) - 3)
typedef struct P6 { /* Liveness */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
} P6;
#define Air6	(sizeof(P6) - 3)
typedef struct P5 { /* Safety2 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
} P5;
...
typedef struct P2 { /* Server */
	...
	uchar id;
	uchar _5_cID;
	struct order _5_customer_order;
} P2;
#define Air2	0
...
typedef struct P1 { /* Cashier */
	...
	uchar id;
	uchar _4_cID;
	struct order _4_customer_order;
} P1;
#define Air1	0
...
#define Air0	(sizeof(P0) - Offsetof(P0, favorite) - 1*sizeof(uchar))
...
#endif
	uchar wants_order[3];
	uchar places_order[3];
	unsigned server_busy : 1;
	uchar customer_waiting;
	uchar cashier_ready;
	uchar server_ready;
	uchar ready_customer;
	uchar ready_order;
	uchar server_got[3];
